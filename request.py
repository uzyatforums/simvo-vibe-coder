...
def get_species_images(taxon_key):
    ...
    occ_params = {"taxonKey": taxon_key, "mediaType": "StillImage", "limit": 3}
    try:
...
# Added 'query' parameter here
def get_animal_data(query):
    species_url = "https://api.gbif.org/v1/species/search"
    species_params = {"datasetKey": DATASET_KEY, "q": query}
    ...
    try:
        ...
        for item in species_data.get('results', []):
            ...
            extracted_item = {
                ...
                'vernacularName': get_safe_vernacular(item),
